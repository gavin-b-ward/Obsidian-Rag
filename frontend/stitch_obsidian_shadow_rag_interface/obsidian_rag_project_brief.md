...
## MVP Scope (Completed)
- [x] High-fidelity dark mode chat interface.
- [x] Animated rotating shadow for the input bar.
- [x] Vault selector and re-indexing state implementation.
- [x] AI "Thinking" state visualization.
- [x] Streamlined navigation (Removed Graph, Archive, Settings for launch focus).
